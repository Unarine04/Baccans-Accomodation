...
<div id="page-wrapper">
    <div class="row"> 
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-white">02 sabi street, penina park</span> <br>
										<span class="text-white"> polokwane</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-white">+27 63 626 6610</span>
										<span class="text-white">+27 63 626 6610 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Adderss</h5>
										<span class="d-table text-white">baccansaccomodation@gmail.com</span>
										<span class="text-white">baccansaccomodation@gmail.com</span>
										</div>
                                </li>
                            </ul>
                        </div>
        ...
        <!--	Map -->
		<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3646.768837738633!2d29.448495774535548!3d-23.933238378546122!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x1ec6d797c3084113%3A0xe435804c7859b094!2s02%20Sabi%20St%2C%20Penina%20Park%2C%20Polokwane%2C%200699!5e0!3m2!1sen!2sza!4v1718957525343!5m2!1sen!2sza"  width="100%" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
		<!--	Map -->
