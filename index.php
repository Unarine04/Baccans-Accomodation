                                    ...
                                    <div class="col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <select class="form-control" name="type">
												...
												<option value="building">Strictly student Building</option>
												<option value="house">House sharing</option>
												<option value="villa">single</option>
												<option value="office">sharing</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-2">
                                        <div class="form-group">
                                            <select class="form-control" name="stype">
												...
												<option value="rent">Self funded</option>
												<option value="sale">Nsfas</option>
                                            </select>
                                        </div>
                                    </div>
